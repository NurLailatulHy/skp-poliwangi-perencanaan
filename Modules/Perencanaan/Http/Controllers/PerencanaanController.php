...
namespace Modules\Perencanaan\Http\Controllers;
...
class PerencanaanController extends Controller
{
    ...
    public function rencanaSkp()
    {
        ...
        return view('perencanaan::rencana.rencana-skp', compact('pegawai'));
    }
    ...
    public function index(Request $request)
    {
        ...
        $parentHasilKerja = HasilKerja::with('rencanakerja.pegawai.timKerjaAnggota')
            ->has('rencanakerja') // pastikan hanya yg punya relasi rencana
            ->get();
        ...
        if ($request->query('params') == 'json') {
            ...
            return view('perencanaan::rencana.rencana-skp', compact('rencana', 'pegawai', 'parentHasilKerja'));
        }
    }
